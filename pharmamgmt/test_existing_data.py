...
def get_existing_data():
    """Get existing suppliers, customers, products"""
    ...
    if not suppliers:
        print("ERROR: No suppliers found! Please add suppliers first.")
        return None, None, None
    
    if not customers:
        print("ERROR: No customers found! Please add customers first.")
        return None, None, None
    
    if not products:
        print("ERROR: No products found! Please add products first.")
        return None, None, None
    
    print(f"✓ Found: {len(suppliers)} suppliers, {len(customers)} customers, {len(products)} products")
...
def run_full_test():
    ...
    print("Using EXISTING suppliers, customers, products")
    print("="*60)
    
    suppliers, customers, products = get_existing_data()
    if not suppliers:
        return
