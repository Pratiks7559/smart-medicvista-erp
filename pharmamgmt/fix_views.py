#!/usr/bin/env python
"""
Script to fix the dateexpiry_inventory_report function in views.py
"""
...
for i, line in enumerate(lines):
    if 'def dateexpiry_inventory_report(request):' in line:
        start_line = i
    if start_line is not None and i > start_line and line.startswith('def ') and not line.startswith('    def'):
        end_line = i
        break

if start_line is None:
    print("ERROR: Could not find dateexpiry_inventory_report function")
    exit(1)
...
print(f"SUCCESS: Successfully replaced dateexpiry_inventory_report function")
print(f"   Removed {end_line - start_line} lines")
print(f"   Added new implementation")
print(f"   Backup saved as core/views_backup.py")
